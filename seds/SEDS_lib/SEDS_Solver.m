function [Priors Mu Sigma cost]=SEDS_Solver(Priors,Mu,Sigma,Data,varargin)
%
...
if strcmpi(options.objective,'mse')
    [Priors Mu Sigma cost]=SEDS_Solver_MSE(Priors,Mu,Sigma,Data,options);
elseif strcmpi(options.objective,'direction')
    [Priors Mu Sigma cost]=SEDS_Solver_Direction(Priors,Mu,Sigma,Data,options);
else
    [Priors Mu Sigma cost]=SEDS_Solver_Likelihood(Priors,Mu,Sigma,Data,options);
end
