function [lambda]=em_mix_lds_inverse(data, n_comp, n_iter, options)
...
for it = 1:n_iter
    ...
    for c=1:n_comp
        ...
        lambda.cov_reg{c} = diag(diag(crop_min_eig(cov_reg, min_eig)));
        ...
        lambda.cov_xloc{c} = crop_min_eig(cov_c_loc, min_eig);
